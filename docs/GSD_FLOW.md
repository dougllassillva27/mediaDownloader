...
- _Nota (Modo Express):_ Para correções de texto ou refatorações de um único arquivo trivial, é permitido pular esta fase com no máximo 1 pergunta.
...
Ao debater decisões passadas, cite sempre o ID da observação correspondente (ex: _"Conforme OBS-20260525-01, a stack base foi..."_).
